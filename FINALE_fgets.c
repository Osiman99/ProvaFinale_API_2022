...
Node *root, *available;
Node *last_not_available = NULL;
Node *not_available = NULL;
Node *last_available = NULL;
char reference[N], *rightLetterAndPlace, *rightLetterWrongPlace, *wrongLetters, *letterOccurrence;
                    ...
                    if (string[1] == 'i'){
                        ...
                        while(string[0] != '+'){
                            ...
                            if (filterWord(node)){
                                ...
                                last_not_available->next = node;            //bisognerebbe inizializzarlo a NULL
                                last_not_available = node;
                            }
                            fgets(string, N, stdin);
                        }
                    }else{
